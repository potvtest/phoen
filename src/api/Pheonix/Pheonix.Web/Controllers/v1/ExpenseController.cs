...
{
    [RoutePrefix("v1/expense"), Authorize]
    public class ExpenseController : ApiController
    {
        ...
        public async Task<bool> SaveOrUpdate(ExpenseViewModel model)
        {
        ...
        public async Task<IEnumerable<ExpenseViewModel>> GetAllList(bool isDraft = false)
        {
        ...
        public async Task<IEnumerable<ExpenseViewModel>> GetList(int expenseId = 0)
        {
        ...
        public async Task<IEnumerable<ExpenseViewModel>> GetApprovals()
        {
            return await service.GetApprovals(RequestContext.GetClaimInt(ClaimTypes.PrimarySid));
        }

        [Route("reject-expense"), HttpPost]
        public async Task<IHttpActionResult> RejectExpense(ExpenseViewModel expense)
        {
        ...
        public async Task<IHttpActionResult> ApproveExpense(ExpenseViewModel expense)
        {
        ...
        public async Task<IHttpActionResult> OnHoldExpense(ExpenseViewModel model)
        {
